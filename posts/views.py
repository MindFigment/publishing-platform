...
def edit_post(request, post_slug):
    ...
    if request.method == 'GET':
        ...
        text_formset = TextFormset(
            initial=post.get_text_sections(),
            prefix=TEXT_PREFIX
        )
        citation_formset = CitationFormset(
            initial=post.get_citation_sections(),
        ...
        if post_form.is_valid() and title_form.is_valid() and subtitle_formset.is_valid() and text_formset.is_valid() and citation_formset.is_valid():
                ...
                with transaction.atomic():
                    ...
                    if len(sections):
                        ...
                        if image_objects:
                            ...
                            image_id = ContentType.objects.get_for_model(
                                Image).id
                            new_story.sections.exclude(
                                content_type=image_id).delete()
