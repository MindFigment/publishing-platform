...
def get_image_preview(obj, image_field_name="image", alt_field_name="title"):
    ...
    if image and alt:
        html_str = HTML_IMG_LINK_TEMPLATE.format(src=image.url, alt=alt)
